...
/*
  Generated class for the AdminChangeStatus page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
  selector: 'page-admin-change-status',
  templateUrl: 'admin-change-status.html'
})
export class AdminChangeStatusPage {
  items: any;
  hostname: string;
  name: any;
  student: any;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public toastCtrl: ToastController, public http: Http) {
    ...
    this.http.get("assets/server.json")
      .subscribe( data => {
        ...
        this.http.post(this.hostname + 'approve/change', body, {headers: headers})
          .subscribe(data => {
